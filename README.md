<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/AIEraDev/wardyn"><img src="https://img.shields.io/badge/i18n-6_Languages-green" alt="i18n" /></a>
  </p>
  <br />
</div>
...
- 🌐 **Multi-Language (i18n) Support**: Instant switching across 6 languages: 🇬🇧 English, 🇫🇷 French, 🇪🇸 Spanish, 🇩🇪 German, 🇨🇳 Chinese, and 🇯🇵 Japanese.
...
| 💼 **LinkedIn** | Social | Active | Personal profile (abdulkabirmusa) timeline ingestion & content briefs |
...
| **Frontend UI** | React 19 + TypeScript 5.8 | Reactive daily brief interface, multi-channel directory, i18n translation engine |
...
| **Auth & Connectors** | OAuth 2.0 PKCE + Gmail & LinkedIn APIs | Native loopback listener (`127.0.0.1:14220`) for secure Gmail & LinkedIn OAuth |
...
Edit `.env` with your Google Cloud & LinkedIn OAuth credentials:
